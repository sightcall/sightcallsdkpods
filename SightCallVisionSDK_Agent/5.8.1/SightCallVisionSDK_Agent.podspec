Pod::Spec.new do |s|
    s.name             = 'SightCallVisionSDK_Agent'
    s.homepage         = 'https://github.com/sightcall/visionsdktestapp'
    s.author           = { 'sightcall' => 'developer@sightcall.com' }
    s.version          = '5.8.1'
    s.source           = { :http => "https://sightcall-ios-cocoapods.s3.amazonaws.com/#{s.name.delete_suffix("_Agent")}_InternalTest/#{s.version}/vsdk_agent.zip" }
