Pod::Spec.new do |s|
    s.name             = 'LSUniversalSDK_Agent'
    s.homepage         = 'https://github.com/sightcall/lsuniversalsdktestapp'
    s.author           = { 'sightcall' => 'developer@sightcall.com' }
    s.version          = '5.8.5'
    s.source           = { :http => "https://sightcall-ios-cocoapods.s3.amazonaws.com/#{s.name.delete_suffix("_Agent")}_InternalTest/#{s.version}/sdk_agent.zip" }
  ...
  s.vendored_frameworks = 'LSUniversalSDK.xcframework',
    ...
    'LSUniversalSDKManager.xcframework'
